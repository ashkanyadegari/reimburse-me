...
ActiveRecord::Schema.define(version: 2021_01_17_165624) do
  ...
  create_table "project_joins", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["project_id"], name: "index_project_joins_on_project_id"
    t.index ["user_id"], name: "index_project_joins_on_user_id"
  end
